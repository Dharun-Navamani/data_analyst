      ...
      <div className="grid gap-6 xl:grid-cols-[1.4fr_0.6fr]">
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-slate-500">Performance overview</p>
              <h2 className="mt-3 text-2xl font-semibold text-slate-900">Growth and user trends</h2>
            </div>
            <button className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">
              Refresh metrics
            </button>
          </div>
          ...
          {loading ? (
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="h-[420px] rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
